...
const Projects = () => {
  const projects = [
    {
      title: 'Netflix Clone',
      description: 'A full-stack MERN application that mimics Netflix UI/UX with user authentication, movie browsing, and watchlist functionality.',
    ...
    {
      title: 'Word Game Website',
      description: 'Multiplayer word game with real-time gameplay, user rankings, and PostgreSQL backend for data persistence.',
